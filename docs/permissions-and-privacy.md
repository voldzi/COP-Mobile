...
| Time Sensitive notifikace | Xcode Time Sensitive Notifications capability; kontrola aktuálního system setting | Společně s notifikačním flow, pouze pro serverem klasifikované události | Doručí se podle běžných pravidel; neslibuje průchod přes Focus | Ne |
