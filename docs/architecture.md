...
| `CSMCommunicationKit` | nativní SwiftUI chat, OIDC/PKCE, Keychain, Matrix Rust E2EE, timeline, communication outbox, omezený Jizda driver-report transport a bezstavové čtení/potvrzení aktivních hlášení | mapu, report stav, moderaci, incident fusion a COP business workflow |
